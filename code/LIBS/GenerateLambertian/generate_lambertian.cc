...
// 	GLfloat light0_specular[] = { 1, 1, 1, 1 };
	...
	light0_position[0] = viewpos[0];
	light0_position[1] = viewpos[1];
	light0_position[2] = viewpos[2];
	light0_position[3] = 1.0f;
// 	glLightfv(GL_LIGHT0, GL_POSITION, viewpos);
