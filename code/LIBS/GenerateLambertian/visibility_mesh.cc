...
// 	GLfloat mat_emission_front[4] = { 1.0, 1.0, 1.0, 1.0 };
// 	GLfloat mat_emission_back[4] = { -1.0, -1.0, -1.0, 1.0 };
	GLfloat mat_emission_front[4] = { 1.0, 0.0, 0.0, 1.0 };
	GLfloat mat_emission_back[4] = { 0.0, 1.0, 0.0, 1.0 };
	glMaterialfv(GL_FRONT, GL_EMISSION, mat_emission_front);
	glMaterialfv(GL_BACK, GL_EMISSION, mat_emission_back);
...
// ./visibility_mesh m-00000000-1_points_only.ply 6 ./Cameras ./Frames 0
