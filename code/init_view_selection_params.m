 view_params= struct;
    ...
    view_params.max_evaluation_points=1000;% maximal number of point to do the statistic over the image (reduce for speed_up)
   ...
   view_params.conf_ratio_threshold=1.1;
